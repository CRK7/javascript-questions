# Elenco di Domande Javascript (Avanzate)

Pubblico quotidianamente domande Javascript a risposta multipla sul mio profilo [Instagram](https://www.instagram.com/theavocoder), che posto anche qui!

Da livello base ad avanzato: verifica la tua conoscenza di Javascript, rinfresca un po' le tue competenze o preparati ad un colloquio tecnico! :muscle: :rocket: Aggiorno questa repo settimanalmente con nuove domande.

Le risposte sono nelle sezioni chiuse sotto le domande che puoi aprire semplicemente cliccandoci sopra. Buona fortuna :heart:
